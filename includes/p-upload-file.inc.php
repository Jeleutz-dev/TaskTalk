...
if (isset($_POST['file-submit']))
{
    ...
    if (empty($fileName)){
        ...
        if(!mysqli_query($conn,$sql))
        {
            ...
            header("Location: ../Professors/collaboration-board.php?course=$course&section=$section&subject=$subject&id=$projid&projname=$projname&grpno=$grpno&grpid=$grpid&leader=$leader&upload_file=success");
            exit();
            }
        }
