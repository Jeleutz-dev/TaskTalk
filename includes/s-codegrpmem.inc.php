...
if (isset($_POST['Add-Button']))
{
    ...
    if (empty($grpcode))
    {
        header("Location: ../Students/project-member.php?error=emptyfields&uid=");
        exit();
    }
    ...
    else
    {
        ...
        if ($existquery_ > 0)
        {
            header("Location: ../Students/project-member.php?user_already_exists_in_group=".$userName);
            exit();
        }
        else
        {
            ...
            if(empty($checkempty['members'])){
                ...
                $sql = "insert into activity_log(uidUsers, action) "
                    ...
                    {
                        header("Location: ../Students/project-member.php?&error=sqlerror");
                        exit();
                    }
                    ...
                    else
                    {
                        ...
                        header("Location: ../Students/project-member.php?&update_members=success");
                        exit();
                    }
            }
...
{
    header("Location: ../Students/project-member.php?");
    exit();
}