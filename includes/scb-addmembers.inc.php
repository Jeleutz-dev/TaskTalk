    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                header("Location: ../Students/collaboration-board.php?course=$course&section=$section&subject=$subject&id=$projId&projname=$projname&grpno=$groupno&grpid=$groupid&leader=$leader&add_members=success");
                exit();
            }
        }
    }
