...
if (isset($_POST['file-submit']))
{
    ...
    if(mysqli_query($conn,$sql))
    {
        $sql = "insert into activity_log(uidUsers, action)"
                    ...
                    header("Location: ../Students/collaboration-board.php?course=$course&section=$section&subject=$subject&id=$projid&projname=$projname&grpno=$grpno&grpid=$grpid&leader=$leader&upload_file=success");
                    exit();
                    }
    }
    else
