...
if (isset($_POST['adminlogin']))
{
    ...
    {
        header("Location: ../a-login.php?error=emptyfields");
        exit();
    }
    else
    {
        ...
        {
            header("Location: ../a-login.php?error=sqlerror");
            exit();
        }
        else
        {
            ...
            {  
                ...
                if ($pwdCheck == false)
                {
                    header("Location: ../a-login.php?error=wrongpwd");
                    exit();
                }
                else if($pwdCheck == true)
                {
                    ...
                    header("Location: ../Admin/audit-trail.php?login=success");
                    exit();
                    }                  
                }
                else
            ...
            {
                header("Location: ../a-login.php?error=nouser");
                exit();
            }
        }
    }
