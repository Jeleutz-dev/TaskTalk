...
if (isset($_POST['Add-Button']))
{
    ...
    if (empty($projcode))
    {
        header("Location: ../Students/project-leader.php?error=emptyfields&uid=");
        exit();
    }
    ...
    else
    {
        ...
        if ($existquery_ > 0)
        {
            header("Location: ../Students/project-leader.php?group_leader_already_exists=".$userName);
            exit();
        }
        else
        {
            ...
            if(empty($checkempty['leader'])){
                ...
                if (!$result)
                {
                    header("Location: ../Students/project-leader.php?&error=sqlerror1");
                    exit();
                }
                else
                {
                    ...
                    {
                        header("Location: ../Students/project-leader.php?&error=sqlerror2");
                        exit();
                    }
                        ...
                        {
                            header("Location: ../Students/project-leader.php?&error=sqlerror3");
                            exit();
                        }
                        ...
                        else
                        {
                            ...
                            header("Location: ../Students/project-leader.php?course=$course&section=$section&subject=$subject&id=$projid&projname=$projname&add_groups=success");
                            exit();
                        }
                    }
...
{
    header("Location: ../Students/project-leader.php?");
    exit();
}