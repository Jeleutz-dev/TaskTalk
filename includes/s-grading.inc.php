...
if (isset($_POST['Submit-Grading']))
{
    ...
    else
    {
        ...
        else
        {
            ...
            header("Location: ../Students/collaboration-board.php?course=$course&section=$section&subject=$subject&id=$projid&projname=$projname&grpno=$grpno&grpid=$grpid&leader=$leader&add_grade=success");
            exit();
            }
