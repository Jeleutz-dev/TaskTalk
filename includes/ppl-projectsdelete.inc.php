...
if (isset($_POST['Delete-Proj']))
{
    ...
    else
    {
        ...
        $sql = "DELETE projects, groups, tasks , subtasks, announcements, comments, peer_grading, projsubmit, gradedproject, fileupload, subj_add, section_add, notifications
        FROM projects 
        ...
        if (!mysqli_query($conn, $sql)) {
            ...
            header("Location: ../Professors/projects.php?course=$course&section=$section&subject=$subject&delete_project=success");
            exit();
            }
