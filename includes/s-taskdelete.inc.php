...
if (isset($_POST['Delete-Task']))
{
    ...
    else
    {
        ...
        $sql = "DELETE tasks , subtasks  
        FROM tasks  INNER JOIN subtasks  
        WHERE tasks.id= subtasks.taskid and tasks.id = '".$taskid."'";
        ...
        // WHERE tasks.id= subtasks.taskid and tasks.id = '".$taskid."'
            ...
            if (mysqli_query($conn, $sql)) {
                    ...
                    header("Location: ../Students/collaboration-board.php?course=$course&section=$section&subject=$subject&id=$projid&projname=$projname&grpno=$grpno&grpid=$grpid&leader=$leader&delete_task=success");
                    exit();
                    }
