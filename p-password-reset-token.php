...
{ 
    ...
    $url = "http://17ae-136-158-31-236.ngrok.io/TaskTalk3/p-reset-password.php?selector=" . $selector . "&validator=" . bin2hex($token) . "&expire=" . $expires;
  ...
  require 'PHPMailer/src/PHPMailerAutoload.php';
    ...
    header("Location: p-forgot-password.php?reset=success");
	  } catch(Exception $e) {
