    ...
    <section>
      ...
      <div class="container">
        <div class="user signinBx">
          ...
          <div class="formBx">
            <form action="includes/s-login.inc.php" method="post">
            <h1><img src="assets/img/student.png" width="50" height="40" alt="LOGO" ></h1>
              <h2>Login</h2>
              <br>
              ...
              <?php 
                  ...
                  else
                  {
                      ...
                      echo '<form method="post" action="includes/s-login.inc.php" id="login-form">
                          ...
                          <p class="signup">
                            <a href="s-forgot-password.php">FORGOT YOUR PASSWORD?</a>
                          </p>  
                          </form>';
