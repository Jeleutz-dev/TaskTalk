...
<div id="main_content">
    ...
    <div id="header_top" class="header_top dark">
        <div class="container">
           <div class="hleft">
            ...
            <div class="hright">
                <div class="dropdown">
                    <a href="../../p-index.php" class="nav-link icon"><img src="../assets/images/home-cln.png"></a>
    ...
    <div class="user_div">
        ...
        <div class="card-body">
            ...
            ?>
            <?php
                $sql4 = mysqli_query($conn,"SELECT * FROM projects WHERE createdby  RLIKE '".$_SESSION['userUid']."' AND projstat = 'On-Going' ORDER BY id DESC LIMIT 2");
    ...
    <div class="page">
        ...
        <!-- style="background: url('../../images/dash-bg.png'); background-size:cover;" -->
...
$(document).ready(function(){
	...
	function make_chat_dialog_box(to_user_id, to_user_name, to_full_name)
	{
		...
		modal_content += '<input type="text" "chat_message_'+to_user_id+'" id="chat_message_'+to_user_id+'" class="form-control chat_message" style="font-color:black;" placeholder="Enter text here...">';
