            ...
            <ul class="metismenu">
                ...
                <?php
                    ...
                    $x=0;
                        ...
                        $x++;
                ?>
                <li style="margin-left:30px;"><a href="project-board.php?course=<?php echo $row["course"]?>&section=<?php echo $row["section"]?>&subject=<?php echo $row["subj_name"]?>&id=<?php echo $row["id"]?>&projname=<?php echo $row["projname"]?>" title="<?php echo $row["projname"]?>"><i ></i><span><?php echo substr($row["projname"],0,8) . '...';?></span></a></li>
        ...
        <div class="section mt-3">
            <div class="section">
                <div class="container-fluid">
                    ...
                    <?php
                        $date1 = strtotime($pdata_['duedate']);
                        $date2 = strtotime("now");
                        
                    
                        if ($date1 < $date2){
                    ?>
                        <span class="tag tag-success ml-0 mr-0">Overdue: <?php echo $pdata_['duedate']?></span>
                    <?php
                        }
                        else{
                    ?>
                        <span class="tag tag-green ml-0 mr-0">Final Submission: <?php echo $pdata_['duedate']?></span>
                    <?php
                        }
                    ?>
                    <h8 style="float: right;"><a href="#"title="Post Announcement" data-toggle="modal" data-target="#uploadFile" style="font-color:#000;">Upload File</a></h8>
                                ...
                                <div class="container" data-aos="fade-up">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                                <div class="member d-flex align-items-center" data-aos="fade-up" data-aos-delay="100" data-toggle="modal" data-target="#addgroup">
                                                    <div class="member-img">
                                                        <a href="#"><img src="assets/images/proj-icon-bl.png" class="img-fluid"  data-toggle="modal" data-target="#addgroups"alt=""></i></a>
                                            ...
                                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                                <div class="member" data-aos="fade-up" data-aos-delay="100">
                                                    ...
                                                    <div class="member-img"></form>
                                                        ...
                                                        <img src="assets/images/proj-icon-bl.png" class="img-fluid" alt=""></button>
                                                    ...
                                                    <div class="social">
                                                        ...
                                                        ?>
                                                           <a data-id="<?php echo $i;?>" data-lead-id="<?php echo $_GET['id'];?>" data-grp-id="<?php echo $groupid?$groupid:"";?>"  title="Update Members" class="open-UpdateMembers" href="#updateMembers" style="font-color:#000;"><i class="bi bi-person-plus-fill"></i></a>
                                                        <?php
                                                            }
                                                        ?>
                                                ...
                                                <div class="member-info">
                                                    ...
                                                    <?php
                                                        $code = mysqli_query($conn, "SELECT * FROM groups WHERE idGroups='".$groupid."' AND projid='".$list['id']."'");
                                                        $y = 0;
                                                        while($grpcode = mysqli_fetch_assoc($code)){
                                                            $y++;
                                                    ?>
                                                    
                                                    <span><i>Share your group code:</i></span> 
                                                    <a href="#"><?php echo $grpcode['grpcode'] ?></a>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                            <div class="member d-flex align-items-center" data-aos="fade-up" data-aos-delay="100" data-toggle="modal" data-target="#addgroup">
                                                <div class="member-img">
                                                    <a href="#"><img src="assets/images/proj-icon-bl.png" class="img-fluid"  data-toggle="modal" data-target="#addgroup"alt=""></i></a>
                                                <div class="member-info" style="text-align:center;">
                                                    <h4>Add Collaborative</h4>
                                                    <h4>Group</h4>
                                                    <span></span>
                                                </div>
                                            </div>
                ...
                <div class="row clearfix row-deck">
                    ...
                    <div class="col-xl-8 col-lg-12 col-md-12">
                        ...
                        <div class="section" style="margin-left:20px; margin-top:20px;">
                            ...
                            <h8 style="float: right; margin-right: 30px;"><a href="#" title="Post Announcement" data-toggle="modal" data-target="#post" style="font-color:#000;">Post</a></h8>
                            <!-- <p>Recent</p> -->
                        </div>
                        ...
                        <?php
                            ...
                            $query = mysqli_query($conn, "SELECT * FROM announcements WHERE course='".$_GET['course']."' AND section='".$_GET['section']."' AND subject='".$_GET['subject']."' ORDER BY datetime DESC Limit 2");
                            $array = array();
...
<form action="../includes/pb-file-upload.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
...
<form action="../includes/p-addmembersupdate.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            url: '../addMembers.php',
            type: 'post',
            data: {"grpid" : myIdgrpId, "projid" : myIdleadId},
            dataType: 'json',
            success:function(response){
...
<!-- Add New Group1-->
<form action="../includes/p-addgroups1.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
...
<!-- Post Announcements -->
<form action="../includes/pb-announcements.php" method='post' id="contact-form" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" class= "form-control" id="title" name="title" placeholder="Title" required/>
                            <br>
                            <textarea class="form-control no-resize" class="form-control" id="annoucements" name="announcements" placeholder="Type your announcement" required></textarea>
                        </div>
                    </div>
                </div>

                <div class="modal-footer">
                    <input type="submit"  class="btn btn-primary"  name="post-announcement" value="Add">
                    <input type="hidden" id="uid" name="uid" value="<?php echo ($_SESSION['userUid']);?>" readonly>
                    <input type="hidden" id="action" name="action" value="Add Project" readonly>
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                </div>
