            ...
            <div class="container-fluid">
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-12">
                        <div class="card">
                            <?php
                                $profile = mysqli_query($conn,"SELECT * FROM user WHERE userType='faculty' AND idUsers='".$_GET['id']."'");
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <!-- <div class="d-flex align-items-baseline">
                                                ...
                                                <p class="mb-0"><span class="text-success"><?php echo round($output,2);?>%</i></span></p>
                                            </div> -->
                                            <!-- <h6 class="text-uppercase font-10">Performance Percentage</h6>
                                            <div class="progress progress-xs">
                                                <div class="progress-bar" role="progressbar" style="width: <?php echo $percent?>%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div> -->
                                        </div>
                                    </div>
                                    <div class="card">
