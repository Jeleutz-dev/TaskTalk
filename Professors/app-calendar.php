...
<script>
   ...
   var calendar = $('#calendar').fullCalendar({
    ...
    select: function(start, end, allDay)
    {
     ...
     if(title)
     {
      var user = ("<?php echo ($_SESSION['f_name']). " " .($_SESSION['l_name']); ?>")
...
<div id="main_content">
    ...
    <div class="user_div">
        <h5 class="brand-name mb-4"><a href="javascript:void(0)" class="user_btn"><img src="assets/images/sidebtn.png"></a></h5>
        <div class="card-body">
