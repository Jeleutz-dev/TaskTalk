    ...
    <section>
      ...
      <div class="container">
        <div class="user signinBx">
          ...
          <div class="formBx">
            <form action="includes/p-login.inc.php" method="post">
              <h1><img src="assets/img/prof.png" width="50" height="40" alt="LOGO" ></h1>
              <h2>Login</h2>
              <br>
              <h2>Professor Module</h2>
              <br>
              ...
              <?php 
                  ...
                  if(isset($_SESSION['userId']))
                  {
                      echo'<div style="text-align: center;">
                              ...
                              <a href="includes/p-logout.inc.php" class="button login">Logout</a>
                          </div>';
                  }
                  else
                  {
                      ...
                      echo '<form method="post" action="includes/p-login.inc.php" id="login-form">
                          ...
                          <p class="signup">
                            <a href="p-forgot-password.php">FORGOT YOUR PASSWORD?</a>
