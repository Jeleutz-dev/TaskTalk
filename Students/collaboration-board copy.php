...
<div id="main_content">
    ...
    <div id="left-sidebar" class="sidebar-dark">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul class="metismenu">
                ...
                <li><a href="associates.php"><i ></i><img src="assets/images/associates.png"><span style="margin-left:5px;" style="margin-left:5px;"> Associates</span></a></li> 
    ...
    <div class="page">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <ul class="list-unstyled feeds_widget">
                                        ...
                                        <li>
                                            <div class="feeds-left"></div>
                                            <div class="feeds-body">
                                                <h4 class="title">Warning<small class="float-right text-muted"></small></h4>
        ...
        <p><a data-id="<?php echo $_GET['id'];?>" data-lead-id="<?php echo $_GET['grpno'];?>" data-grp-id="<?php echo $_GET['grpid'];?>"  title="Add this item" class="open-UpdateMembers" href="#updateMembers" style="font-color:#000;"><i class="bi bi-person-plus-fill">  Add Members</i></a></p>
        <!-- Nav -->
            ...
            <ul class="nav">
                ...
                <?php
                        ...
                        if ($finals == 100){
                            ...
                            if ($rowstmt ==0){
                ?>
                             <li class="nav-item"><a class="" data-toggle="tab" href="#Submit" style="color:red;">Submit Form</a></li>
                <?php     
                            }
                            else {
                ?>
                            ...
                            <div class="row">
                                ...
                                <div class="tab-pane fade show active" id="pills-blog" role="tabpanel" aria-labelledby="pills-blog-tab">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="new_post">
                                                <form action="../includes/s-announcements.php" method='post' id="contact-form" enctype="multipart/form-data">
                                                <div class="form-group">
                                    ...
                                    <div class="card blog_single_post">
                                        ...
                                        <form action="../includes/s-comments.php" method='post' id="contact-form" enctype="multipart/form-data">
                                        <div class="form-group">
                                        ...
                                        <?php
                                            $query1 = mysqli_query($conn, "SELECT * FROM comments where postid = '".$row['id']."' AND projid = '".$_GET['id']."' AND grpno = '".$_GET['grpno']."' AND grpid = '".$_GET['grpid']."' ORDER BY datetime DESC");
                                            $array1 = array();
                                                        ...
                                                        <table class="table table-hover table-vcenter mb-0 table_custom spacing8 text-nowrap">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php
                                                                            if($row['leader'] == 'All'){
                                                                        ?>
                                                                        <a data-id="<?php echo $row['taskname'];?>"  data-task-id="<?php echo $row['id'];?>" title="Add Subtask" class="open-AddSub" href="#addSub" style="font-color:#000;"><i class="bi bi-folder-plus"></i></a>
                                                                        <?php
                                                                            }
                                                                            else{
                                                                        ?>
                                                                        ...
                                                                        <a data-id="<?php echo $row['id'];?>" title="Edit Task Details" class="open-EditTask" href="#editTask" style="font-color:#000;"><i class="bi bi-pencil-square"></i></a>

                                                                        <!-- <a data-id="<?php echo $row['id'];?>" title="Delete Task" class="open-DeleteTask" href="#deleteTask" style="font-color:#000;"><i class="bi bi-trash-fill"></i></a> -->
                                                                        
                                                                        <?php
                                                                            
                                                                            $result2 = mysqli_query($conn, "SELECT * FROM subtasks WHERE grpid='".$_GET['grpid']."' AND grpno = '".$_GET['grpno']."' AND projid = '".$_GET['id']."' and taskid ='".$row['id']."'") or die(mysql_error());
                                                                            $list2 = mysqli_num_rows($result2);

                                                                            if($list2 == 0){
                                                                        ?>
                                                                        <a data-id="<?php echo $row['id'];?>" title="Delete Task" class="open-DeleteTask1" href="#deleteTask1" style="font-color:#000;"><i class="bi bi-trash-fill"></i></a>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <?php 
                                                                                ...
                                                                                if ($date1 < $date2){
                                                                                    ...
                                                                                    if($row['taskstat'] != 'Done'){ 
                                                                        ?>
                                                                                <a data-id="<?php echo $row['id'];?>" title="Edit Status" class="tag tag-success ml-0 mr-0 open-AddTaskstat" href="#addTaskstat" >  Overdue</a>
                                                                        <?php
                                                                                    }
                                                                                    else{
                                                                        ?>
                                                                                <a data-id="<?php echo $row['id'];?>" title="Change Task Status" class="tag tag-success ml-0 mr-0 open-AddTaskstat" href="#addTaskstat"> Overdue (Done)</span></a>
                                                                        <?php
                                                                                    }
                                                                                }
                                                                                else{
                                                                        ...
                                                                        ?>
                                                                                    <a data-id="<?php echo $row['id'];?>" title="Change Task Status" class="tag tag-green ml-0 mr-0 open-AddTaskstat" href="#addTaskstat"><?php echo $row['taskstat'];?></span></a>
                                                                        <?php
                                                                                }
                                                                                elseif($row['taskstat'] == 'Pending'){
                                                                        ?>
                                                                                <a data-id="<?php echo $row['id'];?>" title="Change Task Status" class="tag tag-danger ml-0 mr-0 open-AddTaskstat" href="#addTaskstat"><?php echo $row['taskstat'];?></span></a>
                                                                        <?php
                                                                                }
                                                                                elseif($row['taskstat'] == 'On-Going'){
                                                                        ?>
                                                                                   <a data-id="<?php echo $row['id'];?>" title="Change Task Status" class="tag tag-orange ml-0 mr-0 open-AddTaskstat" href="#addTaskstat"><?php echo $row['taskstat'];?></span></a> 
                                                                        <?php
                                                                                }
                                                                                else{
                                                                        ?>
                                                                                    <a data-id="<?php echo $row['id'];?>" title="Edit Status" class="tag tag-info ml-0 mr-0 open-AddTaskstat" href="#addTaskstat"><i class="bi bi-pencil-square"></i>  <?php echo $row['taskstat'];?></a>
                                                                        <?php
                                                                                }
                                                                            }
                                                                        }
                                                                ...
                                                                <?php
                                                                    ...
                                                                    ?>
                                                                    <td>
                                                                        <!-- <a data-id="<?php echo $row['id'];?>" data-subtask-id="<?php echo $row1['id'];?>" title="Edit Subtask Status" class="open-AddSubstat" href="#addSubstat" style="font-color:#000;"><i class="bi bi-pencil-square"></i></a> -->

                                                                        <a data-id="<?php echo $row1['id'];?>" title="Delete Subtask" class="open-DeleteSubtask" href="#deleteSubtask" style="font-color:#000;"><i class="bi bi-trash-fill"></i></a>

                                                                        <a data-id="<?php echo $row1['id'];?>" title="Upload File" class="open-SuploadFile" href="#suploadFile" style="font-color:#000;"><i class="bi bi-upload"></i></a>
                                                                    </td>
                                                                    <?php
                                                                        }
                                                                    ?>
                                                                    <td>
                                                                        <?php
                                                                            ...
                                                                            if ($date1 < $date2){
                                                                        ?>
                                                                            <a data-id="<?php echo $row['id'];?>" data-subtask-id="<?php echo $row1['id'];?>" title="Edit Subtask Status" class="tag tag-success ml-0 mr-0 open-AddSubstat" href="#addSubstat" style="font-color:#000;">Overdue</a>
                                                                        <?php
                                                                            }
                                                                            else{
                                                                                if($row1['status'] == 'Done'){
                                                                        ?>
                                                                                    <a data-id="<?php echo $row['id'];?>" data-subtask-id="<?php echo $row1['id'];?>" title="Edit Subtask Status" class="tag tag-green ml-0 mr-0 open-AddSubstat" href="#addSubstat" style="font-color:#000;"><?php echo $row1['status'];?></a>
                                                                        <?php
                                                                                }
                                                                                elseif($row1['status'] == 'Pending'){
                                                                        ?>
                                                                                <a data-id="<?php echo $row['id'];?>" data-subtask-id="<?php echo $row1['id'];?>" title="Edit Subtask Status" class="tag tag-danger ml-0 mr-0 open-AddSubstat" href="#addSubstat" style="font-color:#000;"><?php echo $row1['status'];?></a>
                                                                        <?php
                                                                                }
                                                                                elseif($row1['status'] == 'On-Going'){
                                                                        ?>
                                                                                <a data-id="<?php echo $row['id'];?>" data-subtask-id="<?php echo $row1['id'];?>" title="Edit Subtask Status" class="tag tag-orange ml-0 mr-0 open-AddSubstat" href="#addSubstat" style="font-color:#000;"><?php echo $row1['status'];?></a>
                                                                        <?php
                                                                                }
                                                                                else{
                                                                        ?>
                                                                                <a data-id="<?php echo $row['id'];?>" data-subtask-id="<?php echo $row1['id'];?>" title="Edit Subtask Status" class="tag tag-info ml-0 mr-0 open-AddSubstat" href="#addSubstat" style="font-color:#000;"><?php echo $row1['status'];?></a>
                                                                        <?php
                                                                                }
                                                                        ?>
                                                                            <!-- <span class="tag tag-success ml-0 mr-0"><?php echo $row1['status'];?></span> -->
                                                                        <?php
                                                                            }
                                                                        ?>
                                                                    </td>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <style>
                                            ...
                                            <form action="../includes/s-upload-file.inc.php" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="card-body pt-0">
                                                                    <div class="table-responsive">
                                                                        <table class="table table-hover table-vcenter table_custom text-nowrap spacing5 text-nowrap mb-0">
                                                                            ...
                                                                            // run query
                                                                                $query = mysqli_query($conn, "SELECT * FROM fileupload where projid='".($_GET['id'])."'  and leader='".($_GET['leader'])."'  ");
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <?php
                                                                                            ...
                                                                                            $names_ = mysqli_fetch_assoc($names);
                                                                                    ?>
                                                                                    <td class="width100">
                                                                                        <span><?php echo $names_['f_name']." ".$names_['l_name']?></span>
                                                                                    </td>
                                                                                    <td class="width100">
                                                                                        <span></span>
                                                                                    </td>  
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <?php
                                                                                            ...
                                                                                            $nsq = mysqli_query($conn,"SELECT * FROM peer_grading where member = '".$_GET['leader']."' AND projid = '".$_GET['id']."' AND grpid = '".$_GET['grpid']."' AND grpno = '".$_GET['grpno']."'");
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <?php
                                                                                                ...
                                                                                                $nsq = mysqli_query($conn,"SELECT * FROM peer_grading where member = '".$c."' AND projid = '".$_GET['id']."' AND grpid = '".$_GET['grpid']."' AND grpno = '".$_GET['grpno']."'");
                                                                                                $nsq_ = mysqli_num_rows($nsq);
                                                                    ...
                                                                    $x=1;
                                                                        while ($list = mysqli_fetch_assoc($gstmt)) {
                                                                            ...
                                                                            foreach($lead as $c) {
                                                                                ...
                                                                                $nsql1 = mysqli_query($conn,"SELECT * FROM peer_grading where (user = '".$c."' || user = '".$_GET['leader']."') AND projid = '".$_GET['id']."' AND grpid = '".$_GET['grpid']."' AND grpno = '".$_GET['grpno']."'");
...
<form action="../includes/sc-taskfile-upload.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
...
<form action="../includes/sc-deletefile.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
...
<!-- Subtask Upload File -->
<form action="../includes/sc-subtaskfile-upload.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
...
<!-- Subtask Upload File -->
<form action="../includes/sc-editfile-upload.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <input type="hidden" name="etask" id="etask" value="" />
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="dtask" id="dtask" value="" />
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            </div>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                <input type="submit"  class="btn btn-primary"  name="Delete-Task" value="Delete Task">
                <input type="hidden" name="deltask" id="deltask" value="" />
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            </div>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="dsubtask" id="dsubtask" value="" />
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            </div>
            </div>
...
<form action="../includes/scb-updatemembers.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
                                    ...
                                    <input type="hidden" id="createdby" name="createdby" value="<?php echo $_SESSION['userUid'];?>" readonly>
                                    ...
                                    <input type="hidden" id="leader" name="leader" value="<?php echo $_GET['leader'];?>" readonly>
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            url: '../addMembers.php',
            type: 'post',
            data: {"grpid" : myIdgrpId, "grpno" : myIdleadId},
            dataType: 'json',
            success:function(response){
