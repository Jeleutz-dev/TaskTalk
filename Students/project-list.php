                        ...
                        <div class="col-xl-12 col-lg-14 col-md-14">
                            <div class="container" data-aos="fade-up">
                                ...
                                <div class="section-title">
                                    <h2>Collaboration</h2>
                                    <p>Project Leader</p>
                                    <form action="../includes/s-codeproj.inc.php" method="post">
                                        <div class="section-title">
                                ...
                                <div class="row">
                                    <?php
                                        $query = mysqli_query($conn, "SELECT * FROM projects WHERE leader RLIKE '[[:<:]]".$_SESSION['userUid']."[[:>:]]' order by id DESC");
                                        ...
                                        <div class="icon-box">
                                            <div class="icon"><i class="bx bx-file"></i></div>
                                                <form method="GET" action="collaboration-board.php?">
                                                    ...
                                                    <?php 
                                                        $query1 = mysqli_query($conn, "SELECT * FROM groups WHERE leader='". $_SESSION['userUid']."' AND projid = '".$row['id']."'");
                                                ...
                                                <p>Group Code: <?php echo $row1['grpcode'];?></p>
                                                <?php
                                                    $result1 = mysqli_query($conn, "SELECT * FROM tasks WHERE grpid='".$row1['idGroups']."' AND grpno = '".$row1['groupno']."' AND projid = '".$row['id']."'") or die(mysql_error());
                                                    $list1 = mysqli_num_rows($result1);

                                                    if ($list1 == 0) {
                                                ?>
                                                    <p><i style="color: #b79696d1;">This project is not eligible for submission yet.</i></p>
                                                <?php
                                                    }
                                                    else{
                                                        ...
                                                        if ($finals == 100){
                                                            $qstmt = mysqli_query($conn, "SELECT * FROM projsubmit where projid = '".$row['id']."' and grpid = '".$row1['idGroups']."'  ");
                                                            $rowstmt = mysqli_num_rows($qstmt);
            
                                                            if ($rowstmt ==0){
                                                ?>
                                                            <p><i style="color: #b79696d1;">This project is ready to be submitted!</i></p>
                                                <?php     
                                                            }
                                                            else {
                                                ?>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="container" data-aos="fade-up">
                                    <div class="section-title">
                                        <h2>Collaboration</h2>
                                        <p>Project Member</p>
                                        <form action="../includes/s-codegrp.inc.php" method="post">
                                            <div class="section-title">
                                                <div class="header-action d-md-flex"  style="float:right;">
                                                    <input type="text" class="form-groups" name="grpcode" placeholder="Enter Group Code ...">
                                                    <input type="hidden" class="card-title"name="uid" value="<?= $_SESSION['userUid']?>">
                                                    <button type="submit" class="btn btn-primary" name="Add-Button" id="Add-Button"><i class="bi bi-search"></i></button>
                                                    <!-- <input type="submit"  class="btn btn-primary"  name="Add-Audit"><i class="bi bi-search"></i> -->
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="100">
                                            ...
                                            <div class="icon-box"></form>
                                                ...
                                                <p title="<?php echo $row['subject']." - ". $row3['section'] ;?>"><?php echo substr($row['subject'],0,10) . '...'." - ". $row3['section'] ;?></p>
                                                <!-- <p><?php echo $row2['depart_name']; ?></p> -->
                                                <p>Duedate: <?php echo $row1['duedate'];?></p>
                                                <p>Project Code: <?php echo $row1['projcode'];?></p>
                                                <p>Group Code: <?php echo $row['grpcode'];?></p>
                                            </div>  
                                        </div>
