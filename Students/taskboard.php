...
<title>TaskTalk - Taskboard</title>
    ...
    <div id="left-sidebar" class="sidebar-dark">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul class="metismenu">
                ...
                <li class="active"><a href="taskboard.php"><i ></i><img src="assets/images/task-icon.png"><span style="margin-left:10px;"> Taskboard</span></a></li>
                                ...
                                <div class="table-responsive"> <!-- style= "background-color: #ad8875a3;" -->
                                    ...
                                    <!-- <table class="table table-hover table-vcenter mb-0 table_custom spacing8 text-nowrap"> -->
                                        ...
                                        <tbody>
                                            ...
                                            // run query
                                            $query = mysqli_query($conn, "SELECT * FROM tasks where taskmember='".$_SESSION['userUid']."'");
                                            ...
                                            <tr>
                                                ...
                                                <?php echo $row['taskname'];?>
                                                    <!--<ul class="list-unstyled team-info mb-0">
                                                        <li><img src="assets/images/xs/Aldous.jpg" data-toggle="tooltip" data-placement="top" title="Avatar" alt="Avatar"></li>
                                                ...
                                                <td>
                                                    <div class="text-info"><?php echo $row['tduration'];?></div>
                                            ...
                                            <tr>
                                            <?php
                                                $query1 = mysqli_query($conn, "SELECT * FROM subtasks where taskmember='".($_SESSION['userUid'])."'  ");
                                                ...
                                                <td>
                                                    <?php 
                                                        $q1 = mysqli_query($conn, "SELECT * FROM user WHERE userType='student' AND uidUsers='".$row1['taskmember']."'") or die(mysql_error());
