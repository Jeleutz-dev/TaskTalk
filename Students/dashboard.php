                                    ...
                                    <a class="nav-link" href="http://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="assets/images/notif_30px.png"> 
                                        ...
                                        <?php
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow" aria-labelledby="dropdown01">
                                                ...
                                                else if($i['action']=='Add Group Members'){
                                                    echo ucfirst($i['uidUsers'])." added you as a group member in " .$row['projname'].".";
                                                }
                                ...
                                <div class="container" data-aos="fade-up">
                                    <div class="row text-center">
                                        <div class="col-4 border-right pb-4 pt-4">
                                            ...
                                            <?php
                                                $sql = mysqli_query($conn,"SELECT * FROM groups WHERE leader = '".$_SESSION['userUid']."' OR members RLIKE '[[:<:]]".$_SESSION['userUid']."[[:>:]]'");
                                        ...
                                        <div class="col-4 border-right pb-4 pt-4">
                                            ...
                                            <?php
                                                $sql1 = mysqli_query($conn,"SELECT * FROM groups WHERE (leader ='".$_SESSION['userUid']."' OR members RLIKE '".$_SESSION['userUid']."') and projstat = 'On-Going'");
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6 ">
                                            ...
                                            <div class="member-img">
                                                <img src="assets/images/proj-icon-bl.png" class="img-fluid" alt="">
                                            </div>
                                            <div class="member-info">
                                                <h4>Collaboration Leader</h4>
                                                <?php
                                        ...
                                        <div class="col-lg-4 col-md-6 ">
                                            ...
                                            <div class="member-info">
                                                <h4>Collaboration Member</h4>
                                                <?php
                                                    $smem = mysqli_query($conn,"SELECT * FROM groups WHERE members RLIKE '[[:<:]]".$_SESSION['userUid']."[[:>:]]' ");
                                ...
                                <div class="card-body">
                                    <section id="project" class="project">
                                        <div class="container" data-aos="fade-up">
                                            ...
                                            <?php
                                                $countr = mysqli_query($conn, "SELECT * FROM tasks WHERE taskmember='".$_SESSION['userUid']."'order by id DESC LIMIT 1");
                                            ...
                                            <?php
                                                                ...
                                                                // run query
                                                $query = mysqli_query($conn, "SELECT * FROM tasks WHERE (leader='".$_SESSION['userUid']."' AND leader!='All')  OR taskmember = '".$_SESSION['userUid']."'order by id DESC LIMIT 2");
