...
<title>TaskTalk - Grade Board</title>
    ...
    <div id="left-sidebar" class="sidebar-dark">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul class="metismenu">
                ...
                <li class="active"><a href="gradebook.php"><i ></i><img src="assets/images/grade-book.png"><span style="margin-left:6px;"> Grade Book</span></a></li>
                        ...
                        <div class="row clearfix">
                            <div class="col-12 col-sm-12">
                                <div class="table-responsive"> <!-- style= "background-color: #ad8875a3;" -->
                                    <table class="table table-hover table-vcenter mb-0 text-nowrap" style="width: 80%; margin-left: 150px;">
                                    <!-- <table class="table table-hover table-vcenter mb-0 table_custom spacing8 text-nowrap"> -->
                                        ...
                                        <tbody>
                                            ...
                                            // run query
                                            $query = mysqli_query($conn, "SELECT * FROM groups WHERE (leader='".$_SESSION['userUid']."' OR members RLIKE '".$_SESSION['userUid']."') AND projstat = 'Done'");
                                            ...
                                            while($row = mysqli_fetch_assoc($query)){
                                                ...
                                                $pr = mysqli_query($conn, "SELECT * FROM projects WHERE id='".$row['projid']."'");
                                            ...
                                            <tr>
                                                <td><?php echo $x;?></td>
                                                <td>
                                                    <h6 class="mb-0"><?php echo $prj['projname'];?></h6>
                                                </td>
                                                <td>
                                                    <div class="text-pink">Group <?php echo $row['groupno'];?></div>
                                                </td>
                                                <td>
                                                    <?php
                                                        $sec = mysqli_query($conn, "SELECT * FROM section WHERE idSection='".$row['section']."'");
                                                        $sect = mysqli_fetch_assoc($sec);
                                                    ?>
                                                    <div><?php echo $sect['section'];?></div>
                                                </td>
                                                <td>
                                                    <?php
                                                        $sub = mysqli_query($conn, "SELECT * FROM projsubmit WHERE projid='".$row['projid']."' AND grpid='".$row['idGroups']."' AND grpno='".$row['groupno']."'");
                                                        $sub = mysqli_fetch_assoc($sub);
                                                    ?>
                                                    <?php
                                                        $sub1 = mysqli_query($conn, "SELECT * FROM gradedproject WHERE projid='".$row['projid']."' AND grpid='".$row['idGroups']."' AND grpno='".$row['groupno']."'");
                                                        $graded = mysqli_fetch_assoc($sub1);
                                                    ?>
                                                    <div><?php echo $sub['completed_at'];?></div>
                                                    <div><?php echo $prj['duedate'];?></div>
                                                </td>
                                                <td>
                                                    <div><?php echo $graded['grade'];?></div>
                                                </td>
                                                <td>
                                                    <div><?php echo $prj['score'];?></div>
                                                </td>
                                                <td>
                                                    <div><span><a href="../includes/download.inc.php?file=<?php echo $sub['filename'] ?>"><?php echo $sub['filename'] ?></a></span>  </div>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
