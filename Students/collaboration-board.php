                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <?php 
                                                                                ...
                                                                                if ($date1 < $date2){
                                                                                    ...
                                                                                    if($row['taskstat'] != 'Done'){ 
                                                                        ?>
                                                                                <a data-id="<?php echo $row['id'];?>" title="Edit Status" class="tag tag-success ml-0 mr-0 open-AddTaskstat" href="#addTaskstat" >  Overdue (<?php echo $row['taskstat'];?>)</a>
                                                                        <?php
                                                                                    }
                                                                                    else{
                                                                        ?>
                                                                ...
                                                                <?php
                                                                    ...
                                                                    <td>
                                                                        <?php
                                                                            ...
                                                                            if ($date1 < $date2){
                                                                        ?>
                                                                            <a data-id="<?php echo $row['id'];?>" data-subtask-id="<?php echo $row1['id'];?>" title="Edit Subtask Status" class="tag tag-success ml-0 mr-0 open-AddSubstat" href="#addSubstat" style="font-color:#000;">Overdue (<?php echo $row1['status'];?>)</a>
                                                                        <?php
                                                                            }
                                                                            else{
                                                                                if($row1['status'] == 'Done'){
                                                                    ...
                                                                    $x=1;
                                                                        while ($list = mysqli_fetch_assoc($gstmt)) {
                                                                            ...
                                                                            foreach($lead as $c) {
                                                                                ...
                                                                                $nsql2 = mysqli_query($conn,"SELECT Distinct user FROM peer_grading where user = '".$_GET['leader']."' AND projid = '".$_GET['id']."' AND grpid = '".$_GET['grpid']."' AND grpno = '".$_GET['grpno']."'");
                    ...
                    <div class="col-12" style ="text-align: center;">
                        ...
                        <div class="form-group">
                            <select name="file" id="file" class="form-control" required>
                                <option hidden value="">Select a file to submit</option>
                                <?php
                                    $file = mysqli_query($conn,"SELECT * FROM fileupload WHERE projid='".$_GET['id']."' AND grpid='".$_GET['grpid']."' AND grpno='".$_GET['grpno']."'");
                                    while($filesub = mysqli_fetch_assoc($file)){
                                ?>
                                <option value="<?php echo $filesub['filename'];?>"><?php echo $filesub['filename'];?></option>
                                <?php
                                    }
                                ?>
                            </select>
