    ...
    <div id="left-sidebar" class="sidebar-dark">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul class="metismenu">
                ...
                <li><a href="gradeboard.php"><i ></i><img src="assets/images/grade-book.png"><span style="margin-left:6px;"> Grade Board</span></a></li>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="container" data-aos="fade-up">
                                    ...
                                    <div class="row">
                                        ...
                                        ?>
                                            <!-- <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addtask">Add Members</button> -->
                                            <!-- <a data-id="<?php echo $_GET['grpno'];?>" data-lead-id="<?php echo $_GET['leader'];?>" title="Add this item" class="open-AddMembers" href="#addMembers" style="font-color:#000;"><i class="bi bi-person-plus-fill"></i></a> -->
                                        ...
                                        <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="100">
                                            ...
                                            <div class="icon-box"></form>
                                                ...
                                                <button type="submit" class="btn">
                                                    ...
                                                    <?php 
                                                        $query1 = mysqli_query($conn, "SELECT groupno,idGroups FROM groups WHERE leader='".$_SESSION['userUid']."' and projid='".$row['id']."'");
                                                        $row1= mysqli_fetch_assoc($query1);
                                                    ?>
                                                    <input type="text" class="card-title"name="grpno" value="<?php echo $row1['groupno'];?>">
                                                    <input type="text" class="card-title"name="grpid" value="<?php echo $row1['idGroups'];?>">
                                                    <input type="hidden" class="card-title"name="leader" value="<?php echo $_SESSION['userUid']; ?>">
                                                </button>
                                                ...
                                                <p><?php echo $row['subj_name'] ." - ". $row3['section'] ;?></p>
                                                <!-- <p><?php echo $row2['depart_name']; ?></p> -->
                                                <p>Duedate: <?php echo $row['duedate'];?></p>
                                                <?php 
                                                    $taskcomp = mysqli_query($conn, "SELECT * FROM tasks WHERE taskstat = 'Done' AND grpid = '".$row1['idGroups']."' AND projid = '".$row['id']."' AND grpno = '".$row1['groupno']."'");
                                                    $taskcomp_ = mysqli_num_rows($taskcomp);
                                                    $alltask = mysqli_query($conn, "SELECT * FROM tasks WHERE grpid = '".$row1['idGroups']."' AND projid = '".$row['id']."' AND grpno = '".$row1['groupno']."'");
                                                ...
                                                ?>
                                                    ...
                                                    <?php 
                                                        $qstmt = mysqli_query($conn, "SELECT * FROM projsubmit where projid = '".$row['id']."' AND grpid = '".$row1['idGroups']."' AND grpno = '".$row1['groupno']."' ");
                                                        $rowstmt = mysqli_num_rows($qstmt);

                                                            if ($rowstmt !=0){
                                                    ?>

                                                        <p><i style="color: #b79696d1;">The project has been already submitted!</i></p>
                                                        ...
                                                        ?>
                                                            ...
                                                            <p><i style="color: #b79696d1;">The project is now available for submission!</i></p>
                            ...
                            <div class="form-group">
                                <script>
                                    $(document).ready(function() {
                                        ...
                                        $('#add').click(function() {
                                        i++;
                                        $('#dynamic_field').append('<div id="row'+i+'"><label" for="Members_'+ i +'">Group Member '+ i +'</label><?php
                                        $query = mysqli_query($conn, "SELECT * FROM user WHERE userType='student'");
                                        $array = array();

                                        while($row = mysqli_fetch_assoc($query)){
                                        $array[] = $row;
                                        ?><div class="form-group"><select id="members[]" name="members[]" class="form-control" required><?php
                                        $query = mysqli_query($conn, "SELECT * FROM user WHERE userType='student'");
                                        $array = array();
                                        ...
                                        $array[] = $data;
                                        ?>
                                        <option selected hidden value="">Select Member</option><option value="<?php echo $data['uidUsers']; ?>"><?php echo ($data['f_name']) . " " . ($data['l_name']); ?></option><?php }?> </select></div><?php }?> </div>')                     
                                        });
                                    });
                                </script>
                                <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>

                                <div id="dynamic_field"></div><button type="button" class="btn btn-default" name="add" id="add">Add Members</button>
                                    <input type="hidden" id="name" name="uid" value="<?php echo $_SESSION['userUid'];?>">
                                    ...
                                    <input type="hidden" id="action" name="action" value="Add-Member" readonly>
