...
<body>
  ...
  <header id="header" class="fixed-top ">
    ...
    <h1><?php echo'<img id="userDp" src=./uploads/'.$_SESSION["userImg"].'>'?> <a href="Professors/page-profile.php" style="text-align:center;"><?php echo'<h5>' . strtoupper($_SESSION['userUid']) . '</h5>'?></a></h1>
      <!--img src="assets/img/whitelogo.png" alt="San Juan Logo" class="logo"-->
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href='Professors/dashboard.php'>Dashboard</a></li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Services</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="tasktalk/newtasktalk/dashboard.php">Dashboard</a></li>
