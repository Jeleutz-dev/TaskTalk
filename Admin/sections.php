...
if (strlen($_SESSION['userUid'])==0) {
    ...
    $query = "SELECT * FROM `section` LIMIT $start_from, $record_per_page";
    ...
    if(isset($_POST['pdf-submit'])){
        ...
        function generateRow(){
            ...
            while($row = mysqli_fetch_assoc($query)){
                $x++;
                $sql1 = mysqli_query($conn,"SELECT * FROM course where idCourse = '".$row['department']."'");
    ...
    $pdf->SetTitle("Available Sections Table");  
    ...
    $content .= '
        ...
        <h4 align="center" style="font: arial;">Generated PDF for TaskTalk System Available Sections</h4>
        </div>
      	<h4>Available Sections Table</h4>
    ...
    $pdf->Output('tasktalk-sections.pdf', 'I');
    }
                    ...
                    <div class="row clearfix row-deck">
                        <div class="col-xl-12 col-lg-14 col-md-14">
                            <div class="container" data-aos="fade-up">
                                ...
                                <form method="post">
                                     <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#addsec">Add Section</button>&nbsp;&nbsp;
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-hover table-vcenter mb-0 table_custom spacing8 text-nowrap" style="width: 80%; margin-left: 150px;">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $query = "SELECT * FROM `section` WHERE CONCAT(section,department) LIKE '%$filtervalues%' LIMIT $start_from, $record_per_page";
                                        ...
                                        { 
                                            ...
                                            foreach($query_run as $items)
                                            {
                                                ...
                                                <tr>
                                                    <td><?php echo $x;?></td>
                                                    <td>
                                                        <!-- <h6 class="mb-0"><?=$items['section'] ?></h6> -->
                                                        <span><?=$items['section'] ?></span>
                                                    </td>
                                                    <td>
                                                        <?php
                                                            $sql = mysqli_query($conn,"SELECT * FROM course where idCourse = '".$items['department']."'");
                                                            $dpt = mysqli_fetch_assoc($sql);
                                                        ?>
                                                        <?php echo $dpt['depart_name']; ?>
                                                    </td>
                                                    <td><div class="text"><?= $items['idSection']; ?></div></td>
                                                    <form action="" method="GET">
                                                    <td><a data-id="<?= $items['idSection']?>" title="Add Subtask" class="open-EditLog" href="#editLog" style="font-color:#000;"><button type="button" class="btn btn-primarytab">Edit</button></a></td>
                                                    </form>
                                                    <!-- <td><a data-id="<?= $items['idSection']?>" title="Add Subtask" class="open-DeleteLog" href="#deleteLog" style="font-color:#000;"><button type="button" class="btn btn-primarytab">Delete</button></a></td> -->
                                                </tr>
                                                <?php
                                            }
                                        }
                            ...
                            <div align="center">
                                <br />
                                <?php
                                    $page_query = "SELECT * FROM `section` WHERE section LIKE '%$filtervalues%'";
                                    ...
                                    $difference = $total_pages - $page;
                                        ...
                                        if($difference < 1)
                                        {
                                            $start_loop = $total_pages ;
                                             ...
                                             if($page > 1)
                                            {
                                                echo "<a href='sections.php?page=1&search=".$_GET['search']."' style='padding: 8px 16px; border-width: 2px; color:#333; font-weight:bold;'>First</a>";
                                                echo "<a href='sections.php?page=".($page - 1)."&search=".$_GET['search']."' style='padding: 8px 16px; border-width: 2px; color:#333; font-weight:bold;'><<</a>";
                                            }
                                                for($i=$start_loop; $i<=$end_loop; $i++)
                                            {     
                                                echo "<a href='sections.php?page=".$i."&search=".$_GET['search']."' style='padding: 8px 16px; border-width: 2px; color:#333; font-weight:bold;'>".$i."</a>";
                                            }
                                            if($page <= $end_loop)
                                            {
                                                echo "<a href='sections.php?page=".($page + 1)."&search=".$_GET['search']."' style='padding: 8px 16px; border-width: 2px; color:#333; font-weight:bold;'>>></a>";
                                                echo "<a href='sections.php?page=".$total_pages."&search=".$_GET['search']."' style='padding: 8px 16px; border-width: 2px; color:#333; font-weight:bold;'>Last</a>";
                                            }
                                        }
                                            ...
                                            if($page > 1)
                                            {
                                                echo "<a href='sections.php?page=1' style='padding: 8px 16px;  border-width: 2px; color:#333; font-weight:bold;'>First</a>";
                                                echo "<a href='sections.php?page=".($page - 1)."' style='padding: 8px 16px; border-width: 2px; color:#333; font-weight:bold;'><<</a>";
                                            }
                                                for($i=$start_loop; $i<=$end_loop; $i++)
                                            {     
                                                echo "<a href='sections.php?page=".$i."' style='padding: 8px 16px;  border-width: 2px; color:#333; font-weight:bold;'>".$i."</a>";
                                            }
                                            if($page <= $end_loop)
                                            {
                                                echo "<a href='sections.php?page=".($page + 1)."' style='padding: 8px 16px;  border-width: 2px; color:#333; font-weight:bold;'>>></a>";
                                                echo "<a href='sections.php?page=".$total_pages."' style='padding: 8px 16px;  border-width: 2px; color:#333; font-weight:bold;'>Last</a>";
                                            }
                                        }
                                ?>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                    $sql = mysqli_query($conn,"SELECT * FROM course where idCourse = '".$row['department']."'");
                                                    $dpt = mysqli_fetch_assoc($sql);
                                                ?>
                                                <!-- <h6 class="mb-0"><?php echo $dpt["depart_name"]; ?></h6> -->
                                                <span><?php echo $dpt["depart_name"]; ?></span>
                                            </td>
                                            <td>
                                                <?php echo $row["idSection"]; ?>
                                            </td>
                                            <td><a data-id="<?= $row['idSection']?>" title="Add Subtask" class="open-EditLogs" href="#editLogs" style="font-color:#000;"><button type="button" class="btn btn-primarytab">Edit</button></a></td>
                                            <!-- <td><a data-id="<?= $row['idSection']?>" title="Add Subtask" class="open-DeleteLogs" href="#deleteLogs" style="font-color:#000;"><button type="button" class="btn btn-primarytab">Delete</button></a></td> -->
                                        </tr>
                                        <?php
                                            }
                                        ?>
                            ...
                            <div align="center">
                                <br />
                                <?php
                                    $page_query = "SELECT * FROM `section`";
                                    $page_result = mysqli_query($conn, $page_query);
                                    $total_records = mysqli_num_rows($page_result);
                                    $total_pages = ceil($total_records/$record_per_page);
                                    $start_loop = $page;
...
<!-- Edit Sections -->
<form action="../includes/a-editsec.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
<div class="modal fade" id="editLog" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="title" id="defaultModalLabel1">Edit Sections</h6>
            </div>
            <div class="modal-body">
                <div class="row clearfix">
                        <div class="col-12">
                        <div class="form-group">                                    
                            <input type="text" style="margin-left: 0px; text-align:left;" class="form-control" id="uid" name="uid" placeholder="Edit Section">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">                            
                            <select id="action" name="action" class="form-control" required>
                                ...
                                <option value="<?php echo $data['idCourse']; ?>"><?php echo $data['depart_name']; ?></option>
                                <?php
                                    }
                                ?>
                            </select> 
                ...
                <input type="submit"  class="btn btn-primary"  name="Edit-Sec" value="Edit">
                <input type="hidden" name="task" id="task" value="" />
                <input type="hidden" name="user" id="user" value="<?php echo $_SESSION['userUid']?>" />
                <input type="hidden" name="actions" id="actions" value="Edit Sections" />
...
<!-- Edit Sections 2 -->
<form action="../includes/a-editsec2.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                <input type="submit"  class="btn btn-primary"  name="Edit-Sec2" value="Edit">
...
<!-- Delete Sections -->
<form action="../includes/a-deletesec.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
<div class="modal fade" id="deleteLog" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="title" id="defaultModalLabel1">Delete Sec</h6>
            </div>
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-12">
                ...
                <div class="modal-footer">
                <input type="submit"  class="btn btn-primary"  name="Delete-Sec" value="Delete">
                <input type="hidden" name="del" id="del" value="" />
                <input type="hidden" name="user" id="user" value="<?php echo $_SESSION['userUid']?>" />
                <input type="hidden" name="actions" id="actions" value="Delete Sections" />
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            </div>
            </div>
...
<!-- Delete Sections 2 -->
<form action="../includes/a-deletesec2.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
<div class="modal fade" id="deleteLogs" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="title" id="defaultModalLabel1">Delete Sections </h6>
            </div>
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-12">
                ...
                <div class="modal-footer">
                <input type="submit"  class="btn btn-primary"  name="Delete-Sec2" value="Delete">
...
<!-- Add Sections -->
<form action="../includes/a-addsec.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
<div class="modal fade" id="addsec" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                <input type="hidden" name="user" id="user" value="<?php echo $_SESSION['userUid']?>" />
                <input type="hidden" name="actions" id="actions" value="Admin Add Section" />
                <input type="submit"  class="btn btn-dark"  name="Add-Sec" value="Add">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            </div>
            </div>
