...
if (strlen($_SESSION['userUid'])==0) {
    ...
    $query = "SELECT * FROM user WHERE userType = 'student' order by idUsers LIMIT $start_from, $record_per_page";
                                        ...
                                        { 
                                            ...
                                            foreach($query_run as $items)
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <form action="" method="GET">
                                                    <td><a data-id="<?= $items['idUsers']?>" title="Add Subtask" class="open-EditLog" href="#editLog" style="font-color:#000;"><button type="button" class="btn btn-primarytab">Edit</button></a></td>
                                                    </form>
                                                    <td><a data-id="<?= $items['idUsers']?>" title="Add Subtask" class="open-DeleteLog" href="#deleteLog" style="font-color:#000;"><button type="button" class="btn btn-primarytab">Delete</button></a></td>
                                                </tr>
                                                <?php
                                            }
                                        }
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="text"><?php echo $row["headline"]; ?></div>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                                    <div class="float-left"><strong><?php echo $row["bio"]; ?></strong></div>
                                                </div>
                                                </div>
                                            </td>
                                            <td><a data-id="<?= $row['idUsers']?>" title="Add Subtask" class="open-EditLogs" href="#editLogs" style="font-color:#000;"><button type="button" class="btn btn-primarytab">Edit</button></a></td>
                                            <td><a data-id="<?= $row['idUsers']?>" title="Add Subtask" class="open-DeleteLogs" href="#deleteLogs" style="font-color:#000;"><button type="button" class="btn btn-primarytab">Delete</button></a></td>
                                        </tr>
                                        <?php
                                            }
                                        ?>
