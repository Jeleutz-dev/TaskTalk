...
if (strlen($_SESSION['userUid'])==0) {
    ...
    $query = "SELECT * FROM `subject` LIMIT $start_from, $record_per_page";
    ...
    $pdf->SetTitle("Available Subjects Table");  
    ...
    $content .= '
        ...
        <h4 align="center" style="font: arial;">Generated PDF for TaskTalk System Available Subjects</h4>
        </div>
      	<h4>Available Subjects Table</h4>
    ...
    $pdf->Output('tasktalk-subjects.pdf', 'I');
    }
                    ...
                    <div class="row clearfix row-deck">
                        <div class="col-xl-12 col-lg-14 col-md-14">
                            <div class="container" data-aos="fade-up">
                                ...
                                <form method="post">
                                    <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#addsubj">Add Subject</button>&nbsp;&nbsp;
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-hover table-vcenter mb-0 table_custom spacing8 text-nowrap" style="width: 80%; margin-left: 150px;">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $query = "SELECT * FROM `subject` WHERE CONCAT(subject_title,subject_code) LIKE '%$filtervalues%' LIMIT $start_from, $record_per_page";
                                        ...
                                        { 
                                            ...
                                            foreach($query_run as $items)
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="mb-0"><?=$items['subject_code'] ?></h6>
                                                        <span>Something</span>
                                                    </td>
                                                    <td><?= $items['subject_title']; ?></td>
                                                    <td><div class="text"><?= $items['unit']; ?></div></td>
                                                    <td><?= $items['semester']; ?></td>
                                                    <form action="" method="GET">
                                                    <td><a data-id="<?= $items['subject_id']?>" title="Add Subtask" class="open-EditLog" href="#editLog" style="font-color:#000;"><button type="button" class="btn btn-primarytab">Edit</button></a></td>
                                                    </form>
                                                    <td><a data-id="<?= $items['subject_id']?>" title="Add Subtask" class="open-DeleteLog" href="#deleteLog" style="font-color:#000;"><button type="button" class="btn btn-primarytab">Delete</button></a></td>
                                                </tr>
                                                <?php
                                            }
                                        }
                            ...
                            <div align="center">
                                <br />
                                <?php
                                    $page_query = "SELECT * FROM `subject` WHERE CONCAT(subject_title,subject_code) LIKE '%$filtervalues%'";
                                    ...
                                    $difference = $total_pages - $page;
                                        ...
                                        if($page > 1)
                                        {
                                            echo "<a href='subjects.php?page=1&search=".$_GET['search']."' style='padding: 8px 16px; border-width: 2px; color:#333; font-weight:bold;'>First</a>";
                                            echo "<a href='subjects.php?page=".($page - 1)."&search=".$_GET['search']."' style='padding: 8px 16px; border-width: 2px; color:#333; font-weight:bold;'><<</a>";
                                        }
                                            for($i=$start_loop; $i<=$end_loop; $i++)
                                        {     
                                            echo "<a href='subjects.php?page=".$i."&search=".$_GET['search']."' style='padding: 8px 16px; border-width: 2px; color:#333; font-weight:bold;'>".$i."</a>";
                                        }
                                        if($page <= $end_loop)
                                        {
                                            echo "<a href='subjects.php?page=".($page + 1)."&search=".$_GET['search']."' style='padding: 8px 16px; border-width: 2px; color:#333; font-weight:bold;'>>></a>";
                                            echo "<a href='subjects.php?page=".$total_pages."&search=".$_GET['search']."' style='padding: 8px 16px; border-width: 2px; color:#333; font-weight:bold;'>Last</a>";
                                        }
                                ?>
                            </div>
                            <?php
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="mb-0"><?php echo $row["subject_code"]; ?></h6>
                                                <span>Something</span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="text"><?php echo $row["unit"]; ?></div>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                                    <div class="float-left"><strong><?php echo $row["semester"]; ?></strong></div>
                                                </div>
                                                </div>
                                            </td>
                                            <td><a data-id="<?= $row['subject_id']?>" title="Add Subtask" class="open-EditLogs" href="#editLogs" style="font-color:#000;"><button type="button" class="btn btn-primarytab">Edit</button></a></td>
                                            <td><a data-id="<?= $row['subject_id']?>" title="Add Subtask" class="open-DeleteLogs" href="#deleteLogs" style="font-color:#000;"><button type="button" class="btn btn-primarytab">Delete</button></a></td>
                                        </tr>
                                        <?php
                                            }
                                        ?>
                            ...
                            <div align="center">
                                <br />
                                <?php
                                    $page_query = "SELECT * FROM `subject`";
                                    $page_result = mysqli_query($conn, $page_query);
                                    $total_records = mysqli_num_rows($page_result);
                                    $total_pages = ceil($total_records/$record_per_page);
                                    $start_loop = $page;
                                    $difference = $total_pages - $page;
                                        ...
                                        if($page > 1)
                                        {
                                            echo "<a href='subjects.php?page=1' style='padding: 8px 16px;  border-width: 2px; color:#333; font-weight:bold;'>First</a>";
                                            echo "<a href='subjects.php?page=".($page - 1)."' style='padding: 8px 16px; border-width: 2px; color:#333; font-weight:bold;'><<</a>";
                                        }
                                            for($i=$start_loop; $i<=$end_loop; $i++)
                                        {     
                                            echo "<a href='subjects.php?page=".$i."' style='padding: 8px 16px;  border-width: 2px; color:#333; font-weight:bold;'>".$i."</a>";
                                        }
                                        if($page <= $end_loop)
                                        {
                                            echo "<a href='subjects.php?page=".($page + 1)."' style='padding: 8px 16px;  border-width: 2px; color:#333; font-weight:bold;'>>></a>";
                                            echo "<a href='subjects.php?page=".$total_pages."' style='padding: 8px 16px;  border-width: 2px; color:#333; font-weight:bold;'>Last</a>";
                                        }
                                    }
                                ?>
                            </div>
...
<!-- Edit Subj  -->
<form action="../includes/a-editsubj.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
<div class="modal fade" id="editLog" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="title" id="defaultModalLabel1">Edit Subject</h6>
            </div>
            <div class="modal-body">
                <div class="row clearfix">
                        <div class="col-12">
                        <div class="form-group">                                    
                            <input type="text" style="margin-left: 0px; text-align:left;" class="form-control" id="uid" name="uid" placeholder="Edit Subject Code">
                        </div>
                    </div>
                    <div class="col-12">
                    <div class="form-group">
                            <textarea class="form-control" id="action" name="action" placeholder="Edit Subject Title"></textarea>
                        </div>
                    </div>
                             
                </div>
                <div class="modal-footer">
                <input type="submit"  class="btn btn-primary"  name="Edit-Subj" value="Edit">
                <input type="hidden" name="task" id="task" value="" />
                <input type="hidden" name="user" id="user" value="<?php echo $_SESSION['userUid']?>" />
                <input type="hidden" name="actions" id="actions" value="Edit Subj" />
...
<!-- Edit Subj 2 -->
<form action="../includes/a-editsubj2.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                <input type="submit"  class="btn btn-primary"  name="Edit-Subj2" value="Edit">
...
<!-- Delete Subjects -->
<form action="../includes/a-deletesubj.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
<div class="modal fade" id="deleteLog" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="title" id="defaultModalLabel1">Delete Subjects</h6>
            </div>
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-12">
                ...
                <div class="modal-footer">
                <input type="submit"  class="btn btn-primary"  name="Delete-Subj" value="Delete">
                <input type="hidden" name="del" id="del" value="" />
                <input type="hidden" name="user" id="user" value="<?php echo $_SESSION['userUid']?>" />
                <input type="hidden" name="actions" id="actions" value="Delete Subj" />
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            </div>
            </div>
...
<!-- Delete Subj 2 -->
<form action="../includes/a-deletesubj2.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                <input type="submit"  class="btn btn-primary"  name="Delete-Subj2" value="Delete">
...
<!-- Add Subject -->
<form action="../includes/a-addsubj.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row clearfix">
                        ...
                        <div class="col-12">
                            <div class="form-group">                                    
                                <input type="text" class="form-control" id="subjc" name="subjc" placeholder="Subject Code">
                            </div>
                        </div>

                        <div class="col-12">
                            <div class="form-group">                                    
                                <input type="text" class="form-control" id="subjt" name="subjt" placeholder="Subject Title">
                            </div>
                        </div>

                        <div class="col-12">
                            <div class="form-group">                                    
                                <input type="text" class="form-control" id="subju" name="subju" placeholder="Subject Unit">
                            </div>
                        </div>

                        <div class="col-12">
                            <div class="form-group">                                    
                                <input type="text" class="form-control" id="subjs" name="subjs" placeholder="Subject Semester">
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                <input type="hidden" name="user" id="user" value="<?php echo $_SESSION['userUid']?>" />
                <input type="hidden" name="actions" id="actions" value="Admin Add Subject" />
                <input type="submit"  class="btn btn-dark"  name="Add-Subj" value="Add">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            </div>
            </div>
