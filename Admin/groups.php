...
if (strlen($_SESSION['userUid'])==0) {
    ...
    $query = "SELECT * FROM groups order by idGroups LIMIT $start_from, $record_per_page";
    ...
    if(isset($_POST['pdf-submit'])){
        ...
        function generateRow(){
            ...
            while($row = mysqli_fetch_assoc($query)){
                ...
                // $sql3 = mysqli_query($conn,"SELECT * FROM users where uidUsers = '".$row['members']."'");
                ...
                $sql6= mysqli_query($conn,"SELECT * FROM users where uidUsers = '".$row['leader']."'");
    ...
    $content .= '
        ...
        <h4 align="center" style="font: arial;">Generated PDF for TaskTalk System Available Groups</h4>
        </div>
      	<h4>Available Groups Table</h4>
    ...
    $pdf->Output('tasktalk-groups.pdf', 'I');
    }
                    ...
                    <div class="row clearfix">
                        <div class="col-12 col-sm-12">
                            <div class="table-responsive" style="width: 80%; margin-left: 150px; margin-right: 150px;">
                                ...
                                <!-- "table table-hover table-vcenter mb-0 table_custom spacing8 text-nowrap" -->
                                    ...
                                    <?php
                                        ...
                                        $query = "SELECT * FROM groups WHERE CONCAT(subject,leader,members,groupno,projid) LIKE '%$filtervalues%' order by idGroups LIMIT $start_from, $record_per_page";
                                        ...
                                        { 
                                            ...
                                            foreach($query_run as $items)
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span><?= $items['groupno'];?></span></td>
                                                    <td><span><?= $items['leader'];?></span></td>
                                                    <td><span><?= $items['members'];?></span></td>
                                                    <td><span><?= $items['createdby'];?></span></td>
                                                    <td><span><?= $items['created_at'];?></span></td>
                                                    <td><a data-id="<?= $items['idGroups']?>" title="Add Subtask" class="open-EditLog" href="#editLog" style="font-color:#000;"><button type="button" class="btn btn-primarytab">Edit</button></a></td>
                                                    </form>
                                                    <td><a data-id="<?= $items['idGroups']?>" title="Add Subtask" class="open-DeleteLog" href="#deleteLog" style="font-color:#000;"><button type="button" class="btn btn-primarytab">Delete</button></a></td>
                                                </tr>
                                                <?php
                                            }
                                        }
                            ...
                            <div align="center">
                                <br />
                                <?php
                                    $page_query = "SELECT * FROM groups WHERE CONCAT(subject,leader,members,groupno,projid) LIKE '%$filtervalues%' ORDER BY idGroups DESC";
                                    ...
                                    if($difference < 1)
                                    {
                                        $start_loop = $total_pages ;
                                         ...
                                         if($page > 1)
                                        {
                                            echo "<a href='groups.php?page=1&search=".$_GET['search']."' style='padding: 8px 16px; border-width: 2px; color:#333; font-weight:bold;'>First</a>";
                                            echo "<a href='groups.php?page=".($page - 1)."&search=".$_GET['search']."' style='padding: 8px 16px; border-width: 2px; color:#333; font-weight:bold;'><<</a>";
                                        }
                                            for($i=$start_loop; $i<=$end_loop; $i++)
                                        {     
                                            echo "<a href='groups.php?page=".$i."&search=".$_GET['search']."' style='padding: 8px 16px; border-width: 2px; color:#333; font-weight:bold;'>".$i."</a>";
                                        }
                                        if($page <= $end_loop)
                                        {
                                            echo "<a href='groups.php?page=".($page + 1)."&search=".$_GET['search']."' style='padding: 8px 16px; border-width: 2px; color:#333; font-weight:bold;'>>></a>";
                                            echo "<a href='groups.php?page=".$total_pages."&search=".$_GET['search']."' style='padding: 8px 16px; border-width: 2px; color:#333; font-weight:bold;'>Last</a>";
                                        }
                                    }
                                        ...
                                        if($page > 1)
                                        {
                                            echo "<a href='groups.php?page=1' style='padding: 8px 16px;  border-width: 2px; color:#333; font-weight:bold;'>First</a>";
                                            echo "<a href='groups.php?page=".($page - 1)."' style='padding: 8px 16px; border-width: 2px; color:#333; font-weight:bold;'><<</a>";
                                        }
                                            for($i=$start_loop; $i<=$end_loop; $i++)
                                        {     
                                            echo "<a href='groups.php?page=".$i."' style='padding: 8px 16px;  border-width: 2px; color:#333; font-weight:bold;'>".$i."</a>";
                                        }
                                        if($page <= $end_loop)
                                        {
                                            echo "<a href='groups.php?page=".($page + 1)."' style='padding: 8px 16px;  border-width: 2px; color:#333; font-weight:bold;'>>></a>";
                                            echo "<a href='groups.php?page=".$total_pages."' style='padding: 8px 16px;  border-width: 2px; color:#333; font-weight:bold;'>Last</a>";
                                        }
                                    }
                                ?>
                            </div>
                                        ...
                                        ?>
                                             <tr>
                                                ...
                                                <td><span><?= $row['projid'];?></span></td>
                                                    ...
                                                    ?>
                                                <td><span><?= $proj['projname'];?></span></td>
                                                <td><span><?= $row['groupno'];?></span></td>
                                                <td><span><?= $row['leader'];?></span></td>
                                                <td><span><?= $row['members'];?></span></td>
                                                <td><span><?= $row['createdby'];?></span></td>
                                                <td><span><?= $row['created_at'];?></span></td>
                                                <td><a data-id="<?= $row['idGroups']?>" title="Add Subtask" class="open-EditLogs" href="#editLogs" style="font-color:#000;"><button type="button" class="btn btn-primarytab">Edit</button></a></td>
                                                </form>
                                                <td><a data-id="<?= $row['idGroups']?>" title="Add Subtask" class="open-DeleteLogs" href="#deleteLogs" style="font-color:#000;"><button type="button" class="btn btn-primarytab">Delete</button></a></td>
                                            </tr>
                                            <?php
                                                }
                                            ?>
                            ...
                            <div align="center">
                                <br />
                                <?php
                                    $page_query = "SELECT * FROM groups ORDER BY idGroups DESC";
                                    $page_result = mysqli_query($conn, $page_query);
                                    $total_records = mysqli_num_rows($page_result);
                                    $total_pages = ceil($total_records/$record_per_page);
                                    $start_loop = $page;
...
<!-- Edit Groups -->
<form action="../includes/a-editgrp.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
<div class="modal fade" id="editLog" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="title" id="defaultModalLabel1">Edit Group</h6>
            </div>
            <div class="modal-body">
                    <div class="row clearfix">
                        <div class="col-12">
                            ...
                            <select id="leader" name="leader" class="form-control" required>
                                ...
                                <option selected hidden value="">Select Leader</option>
                                ...
                                <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
                                    ...
                                    <input type="hidden" name="idgrp" id="idgrp" value="" />
                                    <input type="hidden" id="name" name="uid" value="<?php echo $_SESSION['userUid'];?>">
                                    <input type="hidden" id="createdby" name="createdby" value="<?php echo ($_SESSION['f_name']) . " " . ($_SESSION['l_name']);?>">
                ...
                <input type="submit"  class="btn btn-primary"  name="Edit-Grp" value="Edit">
                <input type="hidden" name="task" id="task" value="" />
                <input type="hidden" name="user" id="user" value="<?php echo $_SESSION['userUid']?>" />
                <input type="hidden" name="actions" id="actions" value="Edit Grp" />
...
<!-- Edit Group 2 -->
<form action="../includes/a-editgrp2.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                <input type="submit"  class="btn btn-primary"  name="Edit-Grp2" value="Edit">
...
<!-- Delete Group -->
<form action="../includes/a-deletegrp.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                <input type="submit"  class="btn btn-primary"  name="Delete-Grp" value="Delete">
                <input type="hidden" name="del" id="del" value="" />
                <input type="hidden" name="user" id="user" value="<?php echo $_SESSION['userUid']?>" />
                <input type="hidden" name="actions" id="actions" value="Delete Group" />
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            </div>
            </div>
...
<!-- Delete Group 2 -->
<form action="../includes/a-deletegrp2.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                <input type="submit"  class="btn btn-primary"  name="Delete-Grp2" value="Delete">
