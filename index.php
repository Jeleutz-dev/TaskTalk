...
<head>
  ...
  <title>TaskTalk: Online Educational Collaboration Tool</title>
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      <img src="assets/img/simple-logo2.png" alt="" class="logo"></a>
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h1><img src="assets/img/Logowhite.png" class="img-fluid" alt=""></h1>
          <h2>An Online Educational Collaborative Tool</h2>
        </div>
      </div>
      ...
      <div class="row mt-5 justify-content-center" data-aos="zoom-in" data-aos-delay="250">
        <div class="col-xl-4 col-md-4 col-6">
          <div class="icon-box">
            <img src="assets/img/prof.png"></img>
            <h3><a href="p-login.php">Login as Professor</a></h3>
          </div>
        </div>
        <div class="col-xl-4 col-md-4 col-6 ">
          <div class="icon-box">
            <img src="assets/img/student.png"></img>
            <h3><a href="s-login.php">Login as Student</a></h3>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-2 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="member-info">
                ...
                <span>Programmer and Database Programmer</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-2 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="300">
              ...
              <div class="member-info">
                ...
                <span>Programmer and Graphic Artist</span>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            ...
            <a href="a-login.php"><img src="assets/img/LOGO 3.png" width="50" height="40" alt="LOGO" name="adminlogin" class="btn btn-dark"  role="button"> </a>
